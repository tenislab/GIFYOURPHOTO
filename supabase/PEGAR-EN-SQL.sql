-- ============================================================
-- GALERÍA @JRR · PEGAR TODO ESTO EN SUPABASE → SQL EDITOR → RUN
...
-- ============================================================
-- TU CUENTA DE FOTÓGRAFO
-- 1) Regístrate primero en la web con jaimerivasgranada@gmail.com
-- 2) Vuelve aquí y ejecuta esto para darte el rol de fotógrafo
-- ============================================================
update public.profiles
set role = 'owner', name = 'Jaime Rivas Reinoso'
where id = (select id from auth.users where email = 'jaimerivasgranada@gmail.com');

-- Comprobación: debe devolver una fila con role = owner
select p.id, p.name, p.role, u.email
from public.profiles p
join auth.users u on u.id = p.id
where u.email = 'jaimerivasgranada@gmail.com';
